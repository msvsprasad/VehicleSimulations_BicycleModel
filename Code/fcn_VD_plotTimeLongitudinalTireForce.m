function fcn_VD_plotTimeLongitudinalTireForce(time, lon_tire_force, varargin)
...
%   lon_tire_force: A Nx2 matrix of longitudinal tire force(s) [N]
%
% Returned Results:
%   A plot
%
...
max_value = max(lon_tire_force, [], 'all');
min_value = min(lon_tire_force, [], 'all');
...
subplot(2,1,1)
plot(time, lon_tire_force(:,1), 'b', 'Linewidth', 1)
grid on
...
subplot(2,1,2)
plot(time, lon_tire_force(:,2), 'b', 'Linewidth', 1)
grid on
...
sgtitle('Longitudinal Tire Force')
end