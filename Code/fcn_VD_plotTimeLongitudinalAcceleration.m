function fcn_VD_plotTimeLongitudinalAcceleration(time, ...
    longitudinal_acceleration, varargin)
%% fcn_VD_plotTimeLongitudinalAcceleration
% Purpose:
%   To plot the longitudinal acceleration against time
%
% Inputs:
...
set(h_fig, 'Name', 'fcn_VD_plotTimeLongitudinalAcceleration');
width = 600; height = 400; right = 100; bottom = 400;
set(gcf, 'position', [right, bottom, width, height])
clf

plot(time, longitudinal_acceleration, 'g', 'Linewidth', 1)
