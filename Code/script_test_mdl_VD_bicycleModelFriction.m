%% script_test_mdl_VD_bicycleModel_FrictionEst.m
% Plots the results of outputs of a simulink model: 'mdl_VD_bicycleModelFriction'
%
...
sim('mdl_VD_bicycleModelFriction.slx', TotalTime);
